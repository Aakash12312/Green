  ...
  return (
    <div className={`homepage text-${theme === "dark" ? "light" : "dark"}`}>
      ...
      >
        ...
        >
          Play. Learn.{" "}
          <span className={theme === "dark" ? "text-success" : "text-primary"}>
            Go Green.
          </span>
        </motion.h1>
        <motion.p
        ...
        >
          Earn Green Points by saving the planet in fun daily challenges.
        </motion.p>
        <div className="mt-4 d-flex gap-3">
          <a
            href="#"
            className={`btn btn-lg px-4 btn-${
              theme === "dark" ? "success" : "primary"
            }`}
          >
            Start Your Journey
      ...
      <section className="features container py-5 text-center" data-aos="fade-up">
        ...
        <div className="row">
          <div className="col-md-4 mb-4">
            <div
              className={`card feature-card p-4 border-0 shadow ${
      ...
      {/* ================= LEADERBOARD PREVIEW ================= */}
      <section
        className={`leaderboard-preview py-5 ${
          theme === "dark" ? "bg-success bg-opacity-10" : "bg-light"
        }`}
        data-aos="fade-up"
      >
        <div className="container text-center">
          ...
          <div className="table-responsive">
            <table
              ...
              } table-striped table-hover rounded-3 overflow-hidden`}
            >
              <thead>
                <tr>
                  <th>#</th>
      ...
      <footer
        className={`py-4 text-center ${
          theme === "dark" ? "bg-dark text-muted" : "bg-light text-secondary"
        }`}
      >
